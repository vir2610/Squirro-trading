...
(function($) {
	...
	------------------------------------------------------ */
  	...
  	if($("html").hasClass('ie8')) {
  		$("#squirro").backstretch("images/SQ_T_Images/agriculture-cereal-close-up-540925.jpg");  	
  		$("#page-title").backstretch("images/SQ_T_Images/agriculture-cereal-close-up-540925.jpg");
  	}
